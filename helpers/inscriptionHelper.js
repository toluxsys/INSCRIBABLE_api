...
//   try{
//     const inscriptions = await Inscription.find({collectionId: collectionId, collectionPayment: 'received', inscribed: false, sat: "block78"})
...
//     // mintedDup.forEach(x => {
//     //   //if(x.sat !== 'random'){
//     //     if(duplicateImg.includes(x.fileNames[0])){
//     //       console.log(x.id)
//     //       // repeting.push ({
//     //       //   address: x.receiver,
//     //       //   fileName: x.fileNames[0],
